    ...
    public async Task<TicketEditResponse> EditTicketAsync(TicketEditRequest editTicket, int id, int reporterId)
    {
        ...
        if (dbTicket != null)
        {
            ...
            if (dbTicket.ReporterId == reporterId)
            {
                ...
                AddHistoryRecordRequest historyRequest = new AddHistoryRecordRequest 
                { 
                    UserId = reporterId, TicketId = dbTicket.Id, EventType = HistoryEventType.Edit 
                };
                await _HistoryWritter.AddHistoryRecord(historyRequest);
                TicketEditResponse succesResponse = new TicketEditResponse 
                { 
                    Message = "You succesfully edited this ticket!" 
                };
                return succesResponse;
            }
            TicketEditResponse failResponse = new TicketEditResponse 
            { 
                Message = "You did not edit this ticket! You are not the owner of this ticket!" 
            };
            return failResponse;
        }
        TicketEditResponse response = new TicketEditResponse 
        { 
            Message = "You did not edit this ticket! This ticket doesnt exist!" 
        };
        return response;
    }
    ...
    public async Task<TicketEditResponse> DeleteTicketAsync(int id, int reporterId)
    {
        ...
        if (dbTicket != null)
        {
            ...
            if(dbTicket.ReporterId == reporterId)
            {
                ...
                TicketEditResponse succesResponse = new TicketEditResponse 
                { 
                    Message = "You succesfully deleted this ticket!" 
                };
                return succesResponse;
            }
            TicketEditResponse failResponse = new TicketEditResponse 
            { 
                Message = "You did not delete this ticket! You are not the owner of this ticket!" 
            };
            return failResponse;
        }
        TicketEditResponse response = new TicketEditResponse 
        { 
            Message = "You did not delete this ticket! This ticket doesnt exist!" 
        };
        return response;
    }
